...
public interface PostService {
    ...
    void createPost(Post post, int currentUserId, List<MultipartFile> files) throws IOException;
    //게시글 등록
    void updatePost(Post post, int currentUserId, List<MultipartFile> file) throws IOException;
